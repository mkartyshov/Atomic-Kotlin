...
sealed class Transport {
  abstract val capacity: Int // move the capacity property from Bus into the Transport class
}
...
// add new subclasses: 
class Tram( // containing a val route
  val route: String,
  override val capacity: Int
) : Transport()

class Plane( // containing a val flightNumber
