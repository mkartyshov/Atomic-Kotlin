...
class CrocoDuck( // implement Duck and delegate both Duck member functions to crocodile.bite()
...
fun mimicDuck(crocodile: Crocodile): CrocoDuck = // adapts an object, accepting a Crocodile and returning a CrocoDuck
  CrocoDuck(crocodile)
