...
fun cloudiness(cloudPercent: Int): String =
  when (cloudPercent){ // when cloudPercent is in that range, we display the weather
    in 81..100-> "Cloudy"
    in 61..80-> "Mostly Cloudy"
    in 41..60-> "Partly Sunny"
    in 21..40-> "Mostly Sunny"
    in 0..20-> "Sunny"
    else -> throw IllegalArgumentException("Cloudiness value should be between 0 and 100") // else we throw an exception
  }
